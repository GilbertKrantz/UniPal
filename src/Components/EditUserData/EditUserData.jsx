      ...
      <div className='EditUserData__container'>
        ...
        <div className='EditUserData__container--inner'>
          ...
          <div className='EditUserData__container--inner--content'>
            {error && (
              <div className='EditUserData__error-message'>{error}</div>
            )}
            <form className='EditUserData__form' onSubmit={handleSubmit}>
              <div className='EditUserData__input-container'>
                <label htmlFor='username' className='EditUserData__input-label'>
                  Nama:
                </label>
                <input
                  type='text'
                  ...
                  className='EditUserData__input'
                />
              </div>
              <div className='EditUserData__input-container'>
                <label
                  htmlFor='profilePicture'
                  className='EditUserData__input-label'
                >
                  Foto Profil:
                </label>
                <div className='EditUserData__input-file-container'>
                  <button
                    className='EditUserData__input-file-button'
                  ...
                  <label
                    htmlFor='profilePicture'
                    className='EditUserData__input-file'
                  >
                    {fileName}
                  </label>
                  <input
              ...
              <div className='EditUserData__input-password-container'>
                <label htmlFor='password' className='EditUserData__input-label'>
                  Masukkan kata sandi untuk menyimpan perubahan
                </label>
                <div className='Showable-Password'>
                  <input
                    ...
                    className='EditUserData__input-password Password-Spacer'
                  />
              ...
              <button type='submit' className='EditUserData__submit-button'>
                Simpan Perubahan
              </button>
              <Link
                to='/change-password'
                className='EditUserData__change-password'
              >
                Ganti kata sandi
              </Link>
            </form>
