  ...
  return (
    <div className='register'>
      ...
      <CSSTransition
        in={showAlert}
        timeout={200}
        classNames='register__alert--transition'
        unmountOnExit
      >
        ...
        <form onSubmit={handleRegister} className='register__form'>
          <div className='register__input-container'>
            <label htmlFor='name' className='register__input-label'>
              Nama<span className='Required-Input'>*</span>
            </label>
            <input
              autoComplete='off'
              type='text'
            ...
            />
            {validateName(name) !== true && (
              <div className='register__error'>{validateName(name)}</div>
            )}
          </div>
          <div className='register__input-container'>
            <label htmlFor='gender' className='register__input-label'>
              Gender
            </label>
            <div className='register__input-gender-container'>
              <div className='register__gender-choice'>
                <input
                  ...
                  id='male'
                  name='gender'
                  className='register__input-gender'
                  value='Male'
                  checked={gender === 'Male'}
                  onClick={(e) => toggleCheck(e.target.value)}
                  onChange={(e) => setGender(e.target.value)}
                />
                <label htmlFor='male' className='register__gender-label'>
                  Pria
                </label>
              </div>
              <div className='register__gender-choice'>
                <input
                  ...
                  onChange={(e) => setGender(e.target.value)}
                />
                <label htmlFor='female' className='register__gender-label'>
                  Wanita
                </label>
              </div>
            </div>
          ...
          <div className='register__input-container'>
            <label htmlFor='email' className='register__input-label'>
              Alamat Email<span className='Required-Input'>*</span>
            </label>
            <input
              type='email'
              id='email'
          ...
          <div className='register__input-container'>
            <label htmlFor='password' className='register__input-label'>
              Kata Sandi<span className='Required-Input'>*</span>
            </label>
          ...
          <div className='register__input-container'>
            <label htmlFor='confirmPassword' className='register__input-label'>
              Konfirmasi Kata Sandi<span className='Required-Input'>*</span>
            </label>
            <div className='Showable-Password'>
              <input
