  ...
  const getProfilePicture = () => {
    ...
    return (
      <img
        ...
        alt=''
        className='UserProfile__profile-image'
      />
    )
  }
  ...
  return (
    <div className='UserProfile'>
      <CSSTransition
        in={showSettings}
        timeout={200}
        classNames='UserSettings__transition'
        unmountOnExit
      >
      ...
      <div className='UserProfile__container'>
        <div className='UserProfile__profile'>
          ...
          <div className='UserProfile__username'>{userProfile.username}</div>
          <div className='UserProfile__email'>{userProfile.email}</div>
          <button
            className='UserProfile__profile-edit'
